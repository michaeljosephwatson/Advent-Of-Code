...
I thought it would be fun to do Advent of Code this year and thought it would be nice to upload them here.
...
The problems can be found [here](https://adventofcode.com/2025).
